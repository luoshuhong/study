...
public class Main_Test {
	public static final String REF_REMOTES = "git@git.****.com:trade-document/trade-document.git";
	public static final String FILE_DIR = "E:/z-jgit/a.thrift";
			
	
	public static void main(String[] args)  throws Exception {
//		String gitRoot = "ssh://git@git.****.com:trade-document/trade-document.git";
    ...
    public static String getContentWithFile(String gitRoot, final String branchName, String fileName) throws Exception {  
        //克隆  已测试可用
        Git.cloneRepository()
        .setURI("http://git.****.com/trade-document/trade-document.git")
